...
* **agent-cli:** Langchain node types now use @n8n/n8n-nodes-langchain prefix instead of n8n-nodes-langchain
...
* **agent-cli:** prioritize base nodes over langchain variants in index generation ([ef4e05e](https://github.com/EtienneLescot/n8n-as-code/commit/ef4e05e79c9d6e68d8c80a3ad50c24d9abb32236))
