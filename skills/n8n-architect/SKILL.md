...
- Use the exact `{{N8NAC_CMD}} command` and `{{N8N_MANAGER_CMD}} command` listed in `AGENTS.md`. Those context-root commands override the portable examples in this skill.
...
```bash
{{N8NAC_CMD}} skills examples search "<workflow pattern>"
{{N8NAC_CMD}} skills search "<node or capability>"
{{N8NAC_CMD}} skills node-info <nodeName>
{{N8NAC_CMD}} skills validate <workflow.workflow.ts>
```
...
{{N8NAC_CMD}} skills search "<node or capability>"
{{N8NAC_CMD}} skills node-info <nodeName>
{{N8NAC_CMD}} skills node-schema <nodeName>
{{N8NAC_CMD}} skills docs "<topic>"
{{N8NAC_CMD}} skills guides "<topic>"
{{N8NAC_CMD}} skills examples search "<workflow pattern>"
{{N8NAC_CMD}} skills examples info <id>
{{N8NAC_CMD}} skills examples download <id>
```
...
- If setup is missing, use `{{N8N_MANAGER_CMD}}` for instance/auth/runtime and `{{N8NAC_CMD}} workspace ...` for context-root overrides.
